...
namespace Motivation.Infrastructure.Repositories
{
    public class GoalRepository : IGoalRepository
    {
        ...
        public async Task<Goal?> GetByIdAsync(Guid id)
        {
            ...
            return new Goal(cached.Id, cached.UserId, cached.Title, cached.Description, cached.Status, cached.CreatedAt, cached.Deadline, cached.Priority, cached.Notes, cached.IsArchived);
        }
